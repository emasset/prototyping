...
// server can handle.
//
func (client *Client) NetworkList(
	request_body MetadataRequest,
) (
	response *NetworkListResponse,
	err error,
) {
	path := client.service + "/network/list"
	payload := new(bytes.Buffer)
	json.NewEncoder(payload).Encode(request_body)
...
//
func (client *Client) NetworkStatus(
	request_body NetworkRequest,
) (
	response *NetworkStatusResponse,
	err error,
) {
	path := client.service + "/network/status"
	payload := new(bytes.Buffer)
	json.NewEncoder(payload).Encode(request_body)
	req, err := http.NewRequest("POST", path, payload)
	reqHeaders := make(http.Header)
...
//
func (client *Client) NetworkOptions(
	request_body NetworkRequest,
) (
	response *NetworkOptionsResponse,
	err error,
) {
	path := client.service + "/network/options"
	payload := new(bytes.Buffer)
	json.NewEncoder(payload).Encode(request_body)
	req, err := http.NewRequest("POST", path, payload)
	reqHeaders := make(http.Header)
...
//
func (client *Client) Block(
	request_body BlockRequest,
) (
	response *BlockResponse,
	err error,
) {
	path := client.service + "/block"
	payload := new(bytes.Buffer)
	json.NewEncoder(payload).Encode(request_body)
	req, err := http.NewRequest("POST", path, payload)
	reqHeaders := make(http.Header)
...
//
func (client *Client) BlockTransaction(
	request_body BlockTransactionRequest,
) (
	response *BlockTransactionResponse,
	err error,
) {
	path := client.service + "/block/transaction"
	payload := new(bytes.Buffer)
	json.NewEncoder(payload).Encode(request_body)
	req, err := http.NewRequest("POST", path, payload)
	reqHeaders := make(http.Header)
...
func (client *Client) Mempool(
	request_body MempoolRequest,
) (
	response *MempoolResponse,
	err error,
) {
	path := client.service + "/mempool"
	payload := new(bytes.Buffer)
	json.NewEncoder(payload).Encode(request_body)
	req, err := http.NewRequest("POST", path, payload)
	reqHeaders := make(http.Header)
...
//
func (client *Client) MempoolTransaction(
	request_body MempoolTransactionRequest,
) (
	response *MempoolTransactionResponse,
	err error,
) {
	path := client.service + "/mempool/transaction"
	payload := new(bytes.Buffer)
	json.NewEncoder(payload).Encode(request_body)
	req, err := http.NewRequest("POST", path, payload)
	reqHeaders := make(http.Header)
...
func (client *Client) AccountBalance(
	...
	path := client.service + "/account/balance"
	payload := new(bytes.Buffer)
	json.NewEncoder(payload).Encode(request_body)
	req, err := http.NewRequest("POST", path, payload)
	reqHeaders := make(http.Header)
...
//
func (client *Client) ConstructionMetadata(
	request_body ConstructionMetadataRequest,
) (
	response *ConstructionMetadataResponse,
	err error,
) {
	path := client.service + "/construction/metadata"
	payload := new(bytes.Buffer)
	json.NewEncoder(payload).Encode(request_body)
	req, err := http.NewRequest("POST", path, payload)
	reqHeaders := make(http.Header)
...
//
func (client *Client) ConstructionSubmit(
	request_body ConstructionSubmitRequest,
) (
	response *ConstructionSubmitResponse,
	err error,
) {
	path := client.service + "/construction/submit"
	payload := new(bytes.Buffer)
	json.NewEncoder(payload).Encode(request_body)
	req, err := http.NewRequest("POST", path, payload)
	reqHeaders := make(http.Header)
